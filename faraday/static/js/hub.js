...
//             gfx.text(node.name, pt.x, pt.y+7, {color: node.data.tcolor, align:"center", font:"Arial", size:16})
//             gfx.text(node.name, pt.x, pt.y+7, {color: node.data.tcolor, align:"center", font:"Arial", size:16})
//           }else{
//             gfx.rect(pt.x-w/2, pt.y-8, w, 20, 4, {fill:node.data.color, alpha:node.data.alpha})
//             gfx.text(node.name, pt.x, pt.y+9, {color: node.tcolor, align:"center", font:"Arial", size:12})
//             gfx.text(node.name, pt.x, pt.y+9, {color: node.tcolor, align:"center", font:"Arial", size:12})
//           }
//         })
//       },
